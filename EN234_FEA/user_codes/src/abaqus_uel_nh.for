...
!=========================== ABAQUS format user element subroutine ===================
      ...
      SUBROUTINE UEL_F(RHS,AMATRX,SVARS,ENERGY,NDOFEL,NRHS,NSVARS,
    ...
    !     --  Loop over integration points
      do kint = 1, n_points
        ...
        call neohook(PROPS(1:NPROPS),NPROPS,F,JJ,stress,D)
...
!       Geometric stiffness
    ...
    !
     ...
     1                 - N2(1:nfacenodes)*adlmag(j,1)*norm(1:3)*w(kint)      ! Note determinant is already in normal
      ...
      END SUBROUTINE UEL_F


      subroutine neohook(element_properties,n_properties,F,J,stress,D)
